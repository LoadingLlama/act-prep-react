  ...
  container: {
    ...
    '&::before': {
      ...
      background: `
        ...
        radial-gradient(ellipse 1000px 1000px at 0% 0%, rgba(59, 130, 246, 0.12) 0%, transparent 55%),
        radial-gradient(ellipse 900px 900px at -10% 10%, rgba(37, 99, 235, 0.10) 0%, transparent 50%)
      `,
      pointerEvents: 'none',
      zIndex: 0,
