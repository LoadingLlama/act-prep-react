...
export const useLandingPageStyles = createUseStyles({
  ...
  getStartedButton: {
    ...
    cursor: 'pointer',
    transition: 'all 0.25s cubic-bezier(0.4, 0, 0.2, 1)',
    boxShadow: '0 3px 0 0 rgba(5, 150, 105, 0.4)',
    '@media (max-width: 768px)': {
      padding: '5px 10px',
      fontSize: '11px',
      borderRadius: '6px',
      boxShadow: '0 2px 0 0 rgba(5, 150, 105, 0.4)',
    },
    '@media (max-width: 480px)': {
      padding: '4px 8px',
      fontSize: '10px',
    ...
    '&:hover': {
      background: '#047857',
      boxShadow: '0 3px 0 0 rgba(4, 120, 87, 0.5)',
    },
    '&:active': {
      transform: 'scale(0.98)',
    },
  ...
  badge: {
    ...
    '&:hover': {
      transform: 'translateY(-1px)',
      boxShadow: '0 4px 12px rgba(5, 150, 105, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.6)',
    },
  },
  ...
  ctaButton: {
    ...
    '@media (max-width: 768px)': {
      ...
      boxShadow: '0 1px 0 0 rgba(5, 150, 105, 0.4)',
    },
    '@media (max-width: 480px)': {
      fontSize: '9px',
      padding: '7px 10px',
    ...
    '&:active': {
      transform: 'translateY(1px)',
      boxShadow: '0 2px 0 0 rgba(4, 120, 87, 0.5)',
    },
  },
