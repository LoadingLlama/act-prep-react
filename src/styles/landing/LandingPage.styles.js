  ...
  container: {
    ...
    '&::before': {
      ...
      background: `
        ...
        radial-gradient(ellipse 1800px 1800px at -50% 0%, rgba(59, 130, 246, 0.16) 0%, transparent 55%),
        radial-gradient(ellipse 1700px 1700px at -55% 25%, rgba(37, 99, 235, 0.14) 0%, transparent 50%),
        radial-gradient(ellipse 1600px 1800px at -45% 50%, rgba(59, 130, 246, 0.12) 0%, transparent 48%),
        radial-gradient(ellipse 1500px 1700px at -40% 75%, rgba(251, 243, 219, 0.18) 0%, transparent 45%),
        radial-gradient(ellipse 1400px 1600px at -35% 100%, rgba(37, 99, 235, 0.12) 0%, transparent 50%),
    ...
    '&::after': {
      ...
      height: '200%',
      background: `
        radial-gradient(circle 600px at calc(20% + var(--scroll-progress, 0) * 50%) 50%, rgba(59, 130, 246, 0.06) 0%, transparent 40%),
        radial-gradient(circle 700px at calc(80% - var(--scroll-progress, 0) * 40%) calc(80% - var(--scroll-progress, 0) * 50%), rgba(254, 249, 231, 0.22) 0%, transparent 40%)
      `,
      pointerEvents: 'none',
      zIndex: 0,
