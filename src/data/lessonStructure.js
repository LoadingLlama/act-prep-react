export const lessonStructure = [
  ...
  { id: 'sentence-structure', section: 'english', chapterNum: '1.1', title: 'Building Complete Sentences', desc: 'Independent clauses, dependent clauses, compound sentences, and comma splices', status: 'completed', category: 'Grammar Fundamentals' },
  { id: 'commas', section: 'english', chapterNum: '1.2', title: 'Essential Comma Rules', desc: 'Unnecessary information, names rule, listing commas, and adjective lists', status: 'completed', category: 'Grammar Fundamentals' },
  { id: 'punctuation', section: 'english', chapterNum: '1.3', title: 'Advanced Punctuation', desc: 'Semicolons, colons, dashes, apostrophes, and quotation marks', status: 'in-progress', category: 'Grammar Fundamentals' },
  { id: 'verbs', section: 'english', chapterNum: '1.4', title: 'Verbs', desc: 'Subject-verb agreement, verb tense, and irregular verbs', status: 'not-started', category: 'Grammar Fundamentals' },
  { id: 'pronouns', section: 'english', chapterNum: '1.5', title: 'Pronouns', desc: 'Pronoun case, who vs. whom, pronoun agreement, and ambiguous pronouns', status: 'not-started', category: 'Grammar Fundamentals' },
  { id: 'modifiers', section: 'english', chapterNum: '1.6', title: 'Misplaced Modifiers', desc: 'Identifying and correcting misplaced modifiers in sentences', status: 'not-started', category: 'Grammar Fundamentals' },
  { id: 'parallel-structure', section: 'english', chapterNum: '1.7', title: 'Parallel Structure', desc: 'Parallel structure in lists and comparisons', status: 'not-started', category: 'Grammar Fundamentals' },
  { id: 'misc-topics', section: 'english', chapterNum: '1.8', title: 'Miscellaneous Topics', desc: 'Commonly confused words, active vs. passive voice, and prepositional idioms', status: 'not-started', category: 'Grammar Fundamentals' },
  { id: 'grammar-review', section: 'english', chapterNum: '1.9', title: 'Grammar Review', desc: 'Comprehensive review of all grammar concepts', status: 'not-started', category: 'Grammar Fundamentals' },

  // English Section - Rhetorical Skills (Chapter 2)
  { id: 'redundancy', section: 'english', chapterNum: '2.1', title: 'Redundancy & Wordiness', desc: 'Identifying and eliminating redundant and wordy expressions', status: 'not-started', category: 'Rhetorical Skills' },
  { id: 'word-choice', section: 'english', chapterNum: '2.2', title: 'Word Choice', desc: 'Selecting the clearest and most precise words in context', status: 'not-started', category: 'Rhetorical Skills' },
  { id: 'transitions', section: 'english', chapterNum: '2.3', title: 'Transitions', desc: 'Choosing logical transitions between sentences and paragraphs', status: 'not-started', category: 'Rhetorical Skills' },
  { id: 'which-choice', section: 'english', chapterNum: '2.4', title: 'Which Choice Questions', desc: 'Answering specific "which choice" questions about content', status: 'not-started', category: 'Rhetorical Skills' },
  { id: 'adding-deleting', section: 'english', chapterNum: '2.5', title: 'Adding or Deleting Information', desc: 'Determining when to add or delete information from passages', status: 'not-started', category: 'Rhetorical Skills' },
  { id: 'logical-placement', section: 'english', chapterNum: '2.6', title: 'Logical Placement', desc: 'Placing sentences in the most logical order within paragraphs', status: 'not-started', category: 'Rhetorical Skills' },
