/**
 * Get all Test 6 passages with their questions
 */
...
async function getTest6Passages() {
  console.log('🔍 Fetching Test 6 passages...\n');
  ...
  console.log(`📊 Found ${passageIds.length} unique passages for Test 6`);
  ...
  console.log('✅ Saved to test6_passages.json\n');
