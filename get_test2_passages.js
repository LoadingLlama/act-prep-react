/**
 * Get all Test 2 passages with their questions
 */
...
async function getTest2Passages() {
  console.log('🔍 Fetching Test 2 passages...\n');

  // Get all unique passage_ids from Test 2 questions
  ...
  console.log(`📊 Found ${passageIds.length} unique passages for Test 2`);
  ...
  console.log('✅ Saved to test2_passages.json\n');
