...
console.log('Uploading Topic 1.4 - Verbs lesson...\n');

// Read the HTML content
const htmlContent = fs.readFileSync('restructured-english-1.4-v1.html', 'utf-8');
...
console.log('✅ Topic 1.4 - Verbs lesson upload complete!');
