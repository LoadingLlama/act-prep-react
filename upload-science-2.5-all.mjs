  ...
  const examples = [
    {
      ...
      problem_text: `<p style="margin-bottom: 1rem; font-size: 16px; line-height: 1.6;">A group of students investigated how different types of soil affect plant growth. They planted identical seeds in three different soil types and measured growth over 4 weeks.</p>


  <p style="font-weight: 700; font-size: 18px; margin-bottom: 1.2rem; color: #1f2937;">Figure 1</p>
  <p style="margin-bottom: 1rem; font-size: 15px;"><strong>Study Description:</strong> Seeds were planted in clay soil, sandy soil, and loam soil. All plants received equal amounts of water (250 mL per day) and were exposed to 8 hours of sunlight daily. The initial soil pH was adjusted to 6.5 for all soil types before planting. Temperature was maintained at 22°C throughout the experiment.</p>
...
<p style="margin-top: 2.5rem; font-weight: 600; font-size: 17px; color: #1f2937;">How many hours of sunlight did the plants receive each day?</p>`,
      choices: [
...
**The answer is B.**`,
    ...
    },
    {
      ...
      problem_text: `<p style="margin-bottom: 1rem; font-size: 16px; line-height: 1.6;">Scientists studied the effect of temperature on enzyme activity. They measured reaction rates at different temperatures for two enzymes: Enzyme A and Enzyme B.</p>


  <p style="font-weight: 700; font-size: 18px; margin-bottom: 1.2rem; color: #1f2937;">Experiment 1</p>
  <p style="margin-bottom: 1rem; font-size: 15px;"><strong>Procedure:</strong> Enzyme A was tested at temperatures ranging from 20°C to 50°C. The pH was held constant at 7.0. Substrate concentration was 5 mM for all trials. Reaction rate was measured in µmol/min.</p>
  <table style="width: auto; border-collapse: collapse; margin-top: 1.2rem; font-size: 14px;">
    <thead>
      <tr style="background-color: #374151;">
...
<p style="margin-top: 2.5rem; font-weight: 600; font-size: 17px; color: #1f2937;">In Experiment 1, at what pH was Enzyme A tested?</p>`,
      choices: [
        { letter: "A", text: "5.0" },
        { letter: "B", text: "6.0" },
        { letter: "C", text: "7.0" },
