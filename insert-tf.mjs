...
const html = readFileSync('formatted-transforming-functions.html', 'utf-8');
...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: '3', is_correct: false, explanation: 'Transforming Functions can have at most 2 real solutions. Here the discriminant is negative, so 0 real solutions.' },
      { text: 'Infinite', is_correct: false, explanation: 'Transforming Functions have a finite number of solutions. Use discriminant: −16 < 0 means 0 real solutions.' }
    ]
  },
  {
...
console.log('✅ Transforming Functions lesson complete!');
