...
console.log('Uploading Topic 1.5 - Pronouns lesson...\n');

// Read the HTML content
const htmlContent = fs.readFileSync('restructured-english-1.5-v1.html', 'utf-8');
...
console.log('✅ Topic 1.5 - Pronouns lesson upload complete!');
