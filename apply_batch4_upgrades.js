...
async function applyBatch4Upgrades() {
  console.log('='.repeat(100));
  console.log('APPLYING BATCH 4 - 100 ACT-AUTHENTIC QUESTION UPGRADES');
  console.log('='.repeat(100));
  console.log();

  const data = JSON.parse(fs.readFileSync('/tmp/act_replacements_batch4_fixed.json'));
  ...
  console.log(`  Batch 4: ${successful} questions`);
  console.log(`  Total:   ${253 + successful} / 1412 weak questions (${((253 + successful)/1412*100).toFixed(1)}%)`);
  console.log(`  Remaining: ${1412 - 253 - successful} questions`);
  console.log('='.repeat(100));
}

applyBatch4Upgrades().catch(console.error);
