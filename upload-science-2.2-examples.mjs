...
async function uploadExamples() {
  ...
  <p style="margin-bottom: 1rem; font-size: 15px;"><strong>Graph Description:</strong> Bar graph showing Tree Growth (meters) for each forest across three fertilizer treatments</p>
  <table style="width: auto; border-collapse: collapse; margin-top: 1.2rem; font-size: 14px;">
    ...
    <tbody>
      <tr style="background-color: white;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; font-weight: 600; font-size: 14px;">Forest 1</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7; font-weight: 600;">2</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7; font-weight: 600;">4</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7; font-weight: 600;">6</td>
      </tr>
      <tr style="background-color: #f9fafb;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; font-weight: 600; font-size: 14px;">Forest 2</td>
      ...
      <tr style="background-color: white;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; font-weight: 600; font-size: 14px;">Forest 3</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px;">4</td>
      ...
      <tr style="background-color: #f9fafb;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; font-weight: 600; font-size: 14px;">Forest 4</td>
  ...
  <p style="margin-top: 3rem; font-size: 14px; color: #6b7280; font-style: italic;">The graph shows grouped bars for each forest, with three bars representing the three fertilizer treatments.</p>


<p style="margin-top: 2.5rem; font-weight: 600; font-size: 17px; color: #1f2937;">Based on Figure 1, after each successive fertilizer treatment, the growth in meters of the trees in Forest 1:</p>`,
      choices: [
...
**The answer is B.**`,
    ...
    },
    {
      ...
      problem_text: `<p style="margin-bottom: 1rem; font-size: 16px; line-height: 1.6;">A scientist conducted multiple trials measuring various properties of a chemical system. The data collected is shown in the table below.</p>


  <p style="font-weight: 700; font-size: 18px; margin-bottom: 1.2rem; color: #1f2937;">Table 1</p>
  <p style="margin-bottom: 1rem; font-size: 15px;"><strong>Experimental Data:</strong> Multiple trials with varying conditions</p>
  <table style="width: auto; border-collapse: collapse; margin-top: 1.2rem; font-size: 14px;">
    <thead>
      <tr style="background-color: #374151;">
    ...
    <tbody>
      <tr style="background-color: white;">
        ...
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7;">3</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #dbeafe;">4</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7;">6</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #dbeafe;">10</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; font-weight: 600;">12</td>
      </tr>
      <tr style="background-color: #f9fafb;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-weight: 600; font-size: 14px;">2</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7;">5</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #dbeafe;">4</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7;">8</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #dbeafe;">10</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; font-weight: 600;">12</td>
      </tr>
      <tr style="background-color: white;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-weight: 600; font-size: 14px;">3</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7;">7</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #dbeafe;">4</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7;">10</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #dbeafe;">10</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; font-weight: 600;">12</td>
      </tr>
      <tr style="background-color: #f9fafb;">
  ...
  <p style="margin-top: 3rem; font-size: 14px; color: #6b7280; font-style: italic;">Yellow highlighting shows M values; blue highlighting shows constant A and T values in Trials 1-3.</p>


<p style="margin-top: 2.5rem; font-weight: 600; font-size: 17px; color: #1f2937;">As M increased from 3 m to 7 m, while A and T remained constant, X:</p>`,
      choices: [
        { letter: "A", text: "decreased only" },
        { letter: "B", text: "increased only" },
        { letter: "C", text: "increased then decreased" },
