...
async function uploadExamples() {
  ...
  <p style="margin-bottom: 1rem; font-size: 15px;"><strong>Graph Description:</strong> Line graph showing Weekly Growth (cm) vs. Temperature (°F) for three tree types</p>
  <table style="width: auto; border-collapse: collapse; margin-top: 1.2rem; font-size: 14px;">
    ...
    <tbody>
      ...
      <tr style="background-color: white;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; font-weight: 600; font-size: 14px; background-color: #fef3c7;">40</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7;">15</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px;">15</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px;">10</td>
      </tr>
      <tr style="background-color: #f9fafb;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; font-weight: 600; font-size: 14px; background-color: #dbeafe;">45</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #dbeafe; font-style: italic;">~17-18</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px;">—</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px;">—</td>
      </tr>
      <tr style="background-color: white;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; font-weight: 600; font-size: 14px; background-color: #fef3c7;">50</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7;">20</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px;">18</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px;">18</td>
      </tr>
      <tr style="background-color: #f9fafb;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; font-weight: 600; font-size: 14px;">60</td>
  ...
  <p style="margin-top: 3rem; font-size: 14px; color: #6b7280; font-style: italic;">Yellow rows show bracketing data points at 40°F and 50°F. Blue row at 45°F shows the interpolated value (not actually measured).</p>


<p style="margin-top: 2.5rem; font-weight: 600; font-size: 17px; color: #1f2937;">According to Figure 1, at 45°F, the weekly growth rate of Pine would most likely have been:</p>`,
      choices: [
...
**The answer is C.**`,
    ...
    },
    {
      ...
      problem_text: `<p style="margin-bottom: 1rem; font-size: 16px; line-height: 1.6;">A scientist conducted multiple trials measuring various properties of a chemical system under different conditions. The data collected is shown in the table below.</p>
  ...
  <table style="width: auto; border-collapse: collapse; margin-top: 1.2rem; font-size: 14px;">
    ...
    <tbody>
      <tr style="background-color: white;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-weight: 600; font-size: 14px; background-color: #fef3c7;">1</td>
        ...
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; font-weight: 600; background-color: #fef3c7;">12</td>
      </tr>
      <tr style="background-color: #f9fafb;">
      ...
      <tr style="background-color: #f9fafb;">
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-weight: 600; font-size: 14px; background-color: #fef3c7;">4</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #fef3c7;">3</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #dbeafe;">4</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px;">5</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; background-color: #dbeafe;">10</td>
        <td style="padding: 0.5rem; border: 1px solid #d1d5db; text-align: center; font-size: 14px; font-weight: 600; background-color: #fef3c7;">18</td>
      </tr>
      <tr style="background-color: white;">
  ...
  <p style="margin-top: 3rem; font-size: 14px; color: #6b7280; font-style: italic;">Yellow rows (Trials 1 and 4) show the bracketing trials. Blue highlighting shows constant control variables A and T.</p>


<p style="margin-top: 2.5rem; font-weight: 600; font-size: 17px; color: #1f2937;">If X = 5.5 w/a, while M, A, and T remained constant at the values in Trial 1, F would most likely be:</p>`,
      choices: [
