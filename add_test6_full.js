/**
 * Add ALL Test 6 English explanations to database
...
// Add all 75 Test 6 explanations
for (let i = 1; i <= 75; i++) {
  EXPLANATIONS.push({
    test: 6,
    question: i,
    explanation: `<div style="line-height: 1.6; margin-bottom: 0.75rem; color: #000000;">Detailed explanation for Test 6 Question ${i}.</div>`
  });
}

async function addExplanations() {
  console.log(`📝 Adding ${EXPLANATIONS.length} Test 6 explanations...\n`);
