...
async function findRemainingIncompleteQuestions() {
  console.log('Finding ALL remaining questions that lack context...\\n');
  ...
  for (const lessonKey of allEnglishLessons) {
    ...
    for (const q of questions) {
      ...
      const hasLongContext = problemText.length > 300; // Increased threshold
...
findRemainingIncompleteQuestions();
