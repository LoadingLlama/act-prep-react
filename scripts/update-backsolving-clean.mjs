...
<div class="lesson-content">
  ...
  <div class="example-box" style="margin: 2rem 0; padding: 1.5rem; background: #f8f9fa; border-left: 4px solid #4CAF50; border-radius: 4px;">
    <h4 style="margin: 0 0 1rem 0; color: #2c3e50; font-size: 1.1rem;">Example 1</h4>

    <p><strong>Question:</strong> If √(x + 10) − 2√(x − 2) = 0, what is the value of x?</p>
    ...
    <div style="background: white; padding: 1rem; margin: 0.5rem 0; border-radius: 4px;">
    ...
    <p>If we plug in any of the other answer choices, we will get an equation that is not equal on both sides and is incorrect.</p>
  </div>

  <div class="example-box" style="margin: 2rem 0; padding: 1.5rem; background: #f8f9fa; border-left: 4px solid #4CAF50; border-radius: 4px;">
    <h4 style="margin: 0 0 1rem 0; color: #2c3e50; font-size: 1.1rem;">Example 2</h4>

    <p><strong>Question:</strong> Which of the following is a solution to the equation x³ + 5x² + 6x = 0?</p>
    ...
    <p style="margin-top: 1rem;"><strong>Solution:</strong></p>
    <p>Most students look at this question and think, "Oh no, I need to factor this to solve." However, the easiest way to solve this question is backsolving! We plug the answer choices into the equation to see which one makes it equal 0. Below, you can see how the correct answer, when x = −3, makes the equation true.</p>
    ...
    <p>If we plug in any other answer choices, the equation will not equal 0.</p>
  </div>
  ...
  <div class="example-box" style="margin: 2rem 0; padding: 1.5rem; background: #f8f9fa; border-left: 4px solid #4CAF50; border-radius: 4px;">
    <h4 style="margin: 0 0 1rem 0; color: #2c3e50; font-size: 1.1rem;">Example 3</h4>

    <p><strong>Question:</strong> A linear function f passes through the points (1, 5), (3, 9), and (7, 17). Which of the following equations defines f?</p>
    ...
    <div style="background: white; padding: 1rem; margin: 0.5rem 0; border-radius: 4px;">
      <p style="margin: 0.25rem 0;"><strong>For answer choice A:</strong> f(1) = 2(1) + 5 → f(1) = 7 (A is incorrect)</p>
      <p style="margin: 0.25rem 0;"><strong>For answer choice B:</strong> f(1) = 1 + 5 → f(1) = 6 (B is incorrect)</p>
      <p style="margin: 0.25rem 0;"><strong>For answer choice C:</strong> f(1) = 4(1) + 1 → f(1) = 5 ✓ (C works)</p>
      <p style="margin: 0.25rem 0;"><strong>For answer choice D:</strong> f(1) = 2(1) + 3 → f(1) = 5 ✓ (D works)</p>
    </div>

    <p>Answer choices A and B do not work, so we can eliminate those. Answer choices C and D both work, so we need to use a second point to test them. Let's use the point (3, 9).</p>

    <div style="background: white; padding: 1rem; margin: 0.5rem 0; border-radius: 4px;">
      <p style="margin: 0.25rem 0;"><strong>For answer choice C:</strong> f(3) = 4(3) + 1 → f(3) = 13 (C is incorrect)</p>
      <p style="margin: 0.25rem 0;"><strong>For answer choice D:</strong> f(3) = 2(3) + 3 → f(3) = 9 ✓ (D is correct)</p>
    </div>

    <p><strong>Answer: D</strong></p>
    <p>As you can see, we can solve this question by backsolving with points. This method is much easier than solving this question algebraically.</p>
  </div>
...
async function updateBacksolvingLesson() {
  console.log('Updating Backsolving lesson with clean formatting...\n');
  ...
  if (error) {
    ...
    console.log('  ✓ Converted 5 steps into proper ordered list');
    console.log('  ✓ Fixed all 3 examples with proper structure');
    console.log('  ✓ Added solution boxes with clean formatting');
    console.log('  ✓ Added "Key Takeaway" tip box');
    console.log('  ✓ Removed all garbage text and broken HTML');
    console.log('  ✓ Clean headings (1 h2, 4 h3 tags only)');
  }
}
