...
const html = readFileSync('formatted-scientific-notation.html', 'utf-8');

const { data: lesson } = await supabase
  .from('lesson_metadata')
  .select('id')
  .eq('lesson_key', 'scientific-notation')
  .single();
...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: '3', is_correct: false, explanation: 'scientific notation can have at most 2 real solutions. Here the discriminant is negative, so 0 real solutions.' },
      { text: 'Infinite', is_correct: false, explanation: 'scientific notation have a finite number of solutions. Use discriminant: −16 < 0 means 0 real solutions.' }
    ]
  },
  {
...
console.log('✅ scientific notation lesson complete!');
