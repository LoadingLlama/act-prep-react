...
const questions = [
  {
    ...
    underlined_text: "due to",
    context_before: "In June of 1995, ",
    context_after: " NASA technicians inspecting the space shuttle Discovery for an upcoming launch found over two hundred punctures",
    choice_a: "NO CHANGE",
  ...
  {
    question_number: 47,
    question_stem: "two northern flickers, a species of woodpecker, was attempting to excavate a nest",
  ...
  {
    question_number: 50,
    question_stem: "By lacking a distinct song, flickers drum their beaks against hard surfaces to announce themselves to mates.",
    underlined_text: "By lacking",
    context_before: "",
    context_after: " a distinct song, flickers drum their beaks against hard surfaces to announce themselves to mates.",
    choice_a: "NO CHANGE",
  ...
  {
    question_number: 52,
    question_stem: "For solid metal to stop the birds from trying to nest at the launch site, how could NASA prevent damage to its equipment and keep the species safe?",
    underlined_text: "For solid metal to stop",
    context_before: "",
    context_after: " the birds from trying to nest at the launch site, how could NASA prevent damage to its equipment and keep the species safe?",
    choice_a: "NO CHANGE",
  ...
  {
    question_number: 53,
    question_stem: "damage to its equipment and keep the species safe?",
    underlined_text: "its",
    context_before: "damage to ",
  ...
  },
  {
    ...
    underlined_text: "[Paragraph division]",
    context_before: "",
    context_after: "",
    choice_a: "3.",
    choice_b: "4.",
  ...
  },
  {
    ...
    context_before: "The team advised NASA to let the grass grow long to give the birds the impression that food was hard to catch. ",
    context_after: "",
