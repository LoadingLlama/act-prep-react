 ...
 * "Choreographing Change" passage - FINAL ENGLISH PASSAGE
 */
...
console.log('Passage: "Choreographing Change" - FINAL ENGLISH PASSAGE!');
...
const questions = [
  ...
  {
    question_number: 62,
    question_stem: "the often-raw emotional feelings they portrayed.",
    underlined_text: "emotional feelings",
    context_before: "the often-raw ",
  ...
  },
  {
    ...
    underlined_text: "II.",
    context_before: "By the 1920s and up until the onset of World War ",
  ...
  },
  {
    ...
    underlined_text: "—joy, passion, grief—",
    context_before: "Dancers' emotions are conveyed through gestures",
    context_after: "that range from subtle to explosive, stationary to dynamic.",
  ...
  },
  {
    ...
    underlined_text: "prostrate on a stage, covered entirely with soil.",
    context_before: "a dancer lying ",
    context_after: "",
    choice_a: "NO CHANGE",
...
console.log('\n🎉 ALL ENGLISH PASSAGES COMPLETE FOR TEST 4! (75/75 questions)');
if (errors.length > 0) {
