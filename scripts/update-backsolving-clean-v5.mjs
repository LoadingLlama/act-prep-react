...
<div class="lesson-content">
  ...
  <div style="margin: 3rem 0; padding: 2rem; background: #f8fafb !important; border: 2px solid #e5e7eb; border-radius: 12px;">
    ...
    <div style="margin-bottom: 2rem; padding: 1.5rem; background: #e8f5e9 !important; border-radius: 8px;">
      ...
      <p style="margin: 0 0 1rem 0;">If √(x + 10) − 2√(x − 2) = 0, what is the value of x?</p>
    ...
    <div style="margin-bottom: 0; padding: 1.5rem; background: #fff3e0 !important; border-radius: 8px;">
      ...
      <div style="text-align: center; font-family: 'Courier New', monospace; font-size: 1.05rem; line-height: 2; margin: 1.5rem 0; padding: 1rem; background: rgba(255, 255, 255, 0.8) !important; border-radius: 6px;">
        <div>√(6 + 10) − 2√(6 − 2) = 0</div>
        <div>√16 − 2√4 = 0</div>
        <div>4 − 2(2) = 0</div>
        <div>4 − 4 = 0</div>
        <div>0 = 0 ✓</div>
  ...
  <div style="margin: 3rem 0; padding: 2rem; background: #f8fafb !important; border: 2px solid #e5e7eb; border-radius: 12px;">
    ...
    <div style="margin-bottom: 0; padding: 1.5rem; background: #fff3e0 !important; border-radius: 8px;">
      ...
      <div style="text-align: center; font-family: 'Courier New', monospace; font-size: 1.05rem; line-height: 2; margin: 1.5rem 0; padding: 1rem; background: rgba(255, 255, 255, 0.8) !important; border-radius: 6px;">
        <div><strong>For choice A:</strong> f(1) = 2(1) + 5 = 7 ✗</div>
        <div><strong>For choice B:</strong> f(1) = 1 + 5 = 6 ✗</div>
        <div><strong>For choice C:</strong> f(1) = 4(1) + 1 = 5 ✓</div>
        <div><strong>For choice D:</strong> f(1) = 2(1) + 3 = 5 ✓</div>
      </div>
      ...
      <div style="text-align: center; font-family: 'Courier New', monospace; font-size: 1.05rem; line-height: 2; margin: 1.5rem 0; padding: 1rem; background: rgba(255, 255, 255, 0.8) !important; border-radius: 6px;">
        <div><strong>For choice C:</strong> f(3) = 4(3) + 1 = 13 ✗</div>
        <div><strong>For choice D:</strong> f(3) = 2(3) + 3 = 9 ✓</div>
      </div>
...
async function updateBacksolvingLesson() {
  console.log('Updating Backsolving lesson with ultra-clean format...\\n');
  ...
  if (error) {
    ...
    console.log('');
    console.log('Ultra-clean design improvements:');
    console.log('  ✓ Removed complex nested divs - simplified structure');
    console.log('  ✓ Each example in a single container box');
    console.log('  ✓ Clear PROBLEM section (green) and SOLUTION section (orange)');
    console.log('  ✓ All text properly contained in colored boxes');
    console.log('  ✓ Equations centered with clean monospace font');
    console.log('  ✓ Better spacing and padding throughout');
    console.log('  ✓ Stronger borders and visual hierarchy');
  }
}
