...
async function uploadLesson() {
  console.log('Reading restructured Math 2.1 lesson...');
  const newContent = fs.readFileSync('restructured-math-2.1-v1.html', 'utf8');
  ...
  if (data && data.length > 0) {
    ...
    console.log('⚠️  No rows updated. Check if lesson_key "geometry-angles" exists.');
  }
}
