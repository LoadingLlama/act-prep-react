...
async function insertLesson31() {
  console.log('\n' + '='.repeat(60));
  console.log('INSERTING LESSON 3.1: Algebra Skills');
  console.log('='.repeat(60) + '\n');

  try {
    // Read the HTML content
    const content = readFileSync(resolve(__dirname, '../docs/LESSON_3_1_ALGEBRA_SKILLS.html'), 'utf8');
    ...
    console.log('='.repeat(60));
    console.log('✅ SUCCESS! Lesson 3.1 has been inserted!');
    console.log('='.repeat(60));
