...
async function insertLesson25() {
  console.log('\n' + '='.repeat(60));
  console.log('INSERTING LESSON 2.5: Circles, Ellipses, and Hyperbolas');
  console.log('='.repeat(60) + '\n');

  try {
    // Read the HTML content
    const content = readFileSync(resolve(__dirname, '../docs/LESSON_2_5_CIRCLES_ELLIPSES_HYPERBOLAS.html'), 'utf8');
    ...
    console.log('='.repeat(60));
    console.log('✅ SUCCESS! Lesson 2.5 has been inserted!');
    console.log('='.repeat(60));
