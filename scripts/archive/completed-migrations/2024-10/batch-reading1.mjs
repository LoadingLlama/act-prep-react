...
const lessons = {
  'core-principles': {
    ...
    definitions: [
      { term: 'active reading', definition: 'Engaging with text by asking questions, making predictions, noting key ideas' },
      { term: 'main idea', definition: 'Central point or theme of passage. What the passage is mainly about.' },
      { term: 'supporting details', definition: 'Evidence, examples, facts that support the main idea' },
      { term: 'author\'s purpose', definition: 'Reason for writing: inform, persuade, entertain, explain' },
      { term: 'tone', definition: 'Author\'s attitude toward subject: serious, humorous, critical, nostalgic, etc.' },
      { term: 'inference', definition: 'Conclusion based on evidence and reasoning, not directly stated' },
      { term: 'context clues', definition: 'Surrounding words/sentences that help determine meaning of unfamiliar word' }
    ],
    questions: [
      { text: 'What is the main idea?', options: ['A minor detail', 'Central point of passage', 'First sentence', 'Author\'s name', 'Title'], correct: 1, exp: 'Main idea is the central point or theme of the passage' },
      { text: 'What is an inference?', options: ['Stated directly', 'Conclusion you draw', 'Author\'s name', 'Title of passage', 'First paragraph'], correct: 1, exp: 'Inference is a conclusion drawn from evidence, not directly stated' },
      { text: 'Author writes to explain how plants grow. What is the purpose?', options: ['Persuade', 'Entertain', 'Inform/Explain', 'Criticize', 'Confuse'], correct: 2, exp: 'Explaining a process = inform/explain purpose' },
      { text: 'Passage uses words like "unfortunately" and "tragic". What is the tone?', options: ['Happy', 'Critical/Negative', 'Neutral', 'Humorous', 'Excited'], correct: 1, exp: '"Unfortunately" and "tragic" suggest negative/critical tone' },
      { text: 'What are supporting details?', options: ['Main idea', 'Evidence for main idea', 'Title', 'Author bio', 'Conclusion'], correct: 1, exp: 'Supporting details provide evidence/examples for main idea' },
      { text: 'How do you find word meaning using context clues?', options: ['Guess randomly', 'Use surrounding words', 'Skip it', 'Ask someone', 'Look at title'], correct: 1, exp: 'Context clues are surrounding words that hint at meaning' },
      { text: 'What is active reading?', options: ['Reading fast', 'Engaging and thinking', 'Skimming', 'Reading aloud', 'Memorizing'], correct: 1, exp: 'Active reading means engaging with text, asking questions, thinking critically' }
    ]
  },
  'answer-strategies': {
...
async function addAll() {
  console.log('📚 Batch adding first 4 Reading lessons...\n');
  ...
  console.log('🎉 Reading batch 1 complete! Now at 55/82 lessons (67%).');
}
