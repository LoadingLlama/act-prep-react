...
async function uploadLesson() {
  console.log('\n📚 UPLOADING LESSON 4.2: QUADRATICS');
  ...
  const htmlPath = resolve(__dirname, '../docs/LESSON_4_2_QUADRATICS.html');
  ...
  let { data: section, error: getSectionError } = await supabase
    ...
    .eq('section_key', 'quadratics-main')
    .single();
  ...
  console.log('\n' + '='.repeat(80));
  console.log('✅ LESSON 4.2 UPLOADED SUCCESSFULLY!\n');
}
