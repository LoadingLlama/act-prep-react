...
async function insertLesson23() {
  console.log('\n' + '='.repeat(60));
  console.log('INSERTING LESSON 2.3: Lines');
  console.log('='.repeat(60) + '\n');

  try {
    // Read the HTML content
    const content = readFileSync(resolve(__dirname, '../docs/LESSON_2_3_LINES.html'), 'utf8');
    ...
    console.log('='.repeat(60));
    console.log('✅ SUCCESS! Lesson 2.3 has been inserted!');
    console.log('='.repeat(60));
