...
async function insertLesson24() {
  console.log('\n' + '='.repeat(60));
  console.log('INSERTING LESSON 2.4: Arcs and Sectors');
  console.log('='.repeat(60) + '\n');

  try {
    // Read the HTML content
    const content = readFileSync(resolve(__dirname, '../docs/LESSON_2_4_ARCS_SECTORS.html'), 'utf8');
    ...
    console.log('='.repeat(60));
    console.log('✅ SUCCESS! Lesson 2.4 has been inserted!');
    console.log('='.repeat(60));
