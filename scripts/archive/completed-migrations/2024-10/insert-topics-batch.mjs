...
const lessons = [
  {
    ...
    duration_minutes: 35,
    order_index: 7,
    content_file: 'TOPIC_2_2_AREAS_VOLUMES_TRIANGLES_CONTENT.html',
    quiz_file: 'TOPIC_2_2_AREAS_VOLUMES_TRIANGLES_QUIZ.html'
  },
  {
    lesson_key: '2.3',
    title: 'Lines',
    ...
    duration_minutes: 30,
    order_index: 8,
    content_file: 'TOPIC_2_3_LINES_CONTENT.html',
    quiz_file: 'TOPIC_2_3_LINES_QUIZ.html'
  },
  {
    lesson_key: '3.1',
    ...
    duration_minutes: 30,
    order_index: 9,
    content_file: 'TOPIC_3_1_ALGEBRA_SKILLS_CONTENT.html',
    quiz_file: 'TOPIC_3_1_ALGEBRA_SKILLS_QUIZ.html'
  },
  {
    lesson_key: '3.2',
    title: 'Fractions',
    ...
    duration_minutes: 30,
    order_index: 10,
    content_file: 'TOPIC_3_2_FRACTIONS_CONTENT.html',
    quiz_file: 'TOPIC_3_2_FRACTIONS_QUIZ.html'
  },
  {
    lesson_key: '3.3',
    ...
    duration_minutes: 35,
    order_index: 11,
    content_file: 'TOPIC_3_3_EXPONENTS_ROOTS_CONTENT.html',
    quiz_file: 'TOPIC_3_3_EXPONENTS_ROOTS_QUIZ.html'
  }
];
...
async function insertAllLessons() {
  ...
  console.log('║' + ' '.repeat(20) + 'BATCH LESSON INSERTION' + ' '.repeat(36) + '║');
  console.log('╚' + '═'.repeat(78) + '╝');
