...
async function insertLesson33() {
  console.log('\n' + '='.repeat(60));
  console.log('INSERTING LESSON 3.3: Exponents and Roots');
  console.log('='.repeat(60) + '\n');

  try {
    // Read the HTML content
    const content = readFileSync(resolve(__dirname, '../docs/LESSON_3_3_EXPONENTS_ROOTS.html'), 'utf8');
    ...
    console.log('='.repeat(60));
    console.log('✅ SUCCESS! Lesson 3.3 has been inserted!');
    console.log('='.repeat(60));
