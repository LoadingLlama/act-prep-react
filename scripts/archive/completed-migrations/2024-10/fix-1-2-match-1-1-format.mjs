...
// EXACT format from lesson 1.1 - simple, clean examples
...
async function matchFormat() {
  console.log('Matching EXACT format from lesson 1.1...\n');
  ...
  console.log('✅ Fixed! Examples now match lesson 1.1 format EXACTLY:');
  console.log('  - Simple clean layout');
  console.log('  - Red left border on example headers');
  console.log('  - Times New Roman answer choices with <br> tags');
  console.log('  - Solution always visible');
  console.log('  - Bullet list format');
  console.log('');
  console.log('Refresh your browser!');
}

matchFormat().catch(console.error);
