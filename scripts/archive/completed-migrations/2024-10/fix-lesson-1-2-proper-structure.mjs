...
// PROPER STRUCTURE: Examples integrated into teaching sections
...
async function fixLesson12Structure() {
  console.log('Fixing Lesson 1.2 - Proper Structure with Integrated Examples...\n');
  ...
  // Insert new properly structured content
  console.log('Inserting Block 1 (Intro + Section 1 with Example 1 + Section 2)...');
  await supabase
    .from('section_content')
    .insert({
  ...
  console.log('Inserting Block 2 (Examples 2-3 + Section 3 + Key Takeaways)...');
  await supabase
    .from('section_content')
    .insert({
      section_id: mainSection.id,
  ...
  console.log('\n✅ SUCCESS! Lesson 1.2 restructured with examples integrated into sections.');
  console.log('\nStructure now:');
  console.log('  - Intro');
  console.log('  - Section 1: What Is Number Substitution?');
  console.log('    → Example 1 (integrated)');
  console.log('  - Section 2: The Substitution Process');
  console.log('    → Example 2 (integrated)');
  console.log('    → Example 3 (integrated)');
  console.log('  - Section 3: Common Pitfalls and ACT Tips');
  console.log('  - Key Takeaways');
  console.log('  - Mastery Check Quiz (already exists)');
  console.log('\nRefresh your browser!');
}

fixLesson12Structure().catch(console.error);
