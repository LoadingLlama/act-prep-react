...
// Fixed content with proper answer choice formatting
...
<p style="font-family: 'Times New Roman', Times, Georgia, serif; margin: 0.5rem 0; line-height: 1.8;">
A. <em>x</em><sup>2</sup> + 15<br>
B. <em>x</em><sup>2</sup> + 8<em>x</em> + 8<br>
C. <em>x</em><sup>2</sup> + 8<em>x</em> + 15<br>
D. 2<em>x</em> + 8<br>
E. <em>x</em><sup>2</sup> + 15<em>x</em>
</p>
...
F. 0%<br>
G. −<em>p</em>%<br>
H. −<em>p</em><sup>2</sup>/100%<br>
J. <em>p</em><sup>2</sup>%<br>
K. −2<em>p</em>%
</p>
...
async function fixAnswerFormatting() {
  console.log('Fixing answer choice formatting in examples...\n');
  ...
  console.log('✅ Fixed! Answer choices now have proper line breaks.');
  console.log('Refresh your browser to see the formatted answer choices.');
}

fixAnswerFormatting().catch(console.error);
