...
async function insertLesson22() {
  console.log('\n' + '='.repeat(60));
  console.log('INSERTING LESSON 2.2: Areas, Volumes & Triangles');
  console.log('='.repeat(60) + '\n');

  try {
    // Read the HTML content
    const content = readFileSync(resolve(__dirname, '../docs/LESSON_2_2_AREAS_VOLUMES_TRIANGLES.html'), 'utf8');
    ...
    console.log('='.repeat(60));
    console.log('✅ SUCCESS! Lesson 2.2 has been inserted!');
    console.log('='.repeat(60));
