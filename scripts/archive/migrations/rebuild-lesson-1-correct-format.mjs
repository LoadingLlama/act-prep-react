...
// Lesson 1 with CORRECT format for InteractiveExample component
...
async function rebuildLesson1() {
  console.log('🔧 REBUILDING LESSON 1 WITH CORRECT FORMAT...\n');
  console.log('Fixing:');
  console.log('  1. Using <ol> for numbered list (1-5)');
  console.log('  2. Separating Problem: and question text into different <p> tags');
  console.log('  3. Separating Solution: and solution text into different <p> tags\n');
  ...
  if (error) {
    ...
    console.log('✅ Lesson 1 rebuilt with correct format!');
    console.log('   ✅ Steps are now numbered (1-5)');
    console.log('   ✅ Examples formatted correctly for InteractiveExample component');
    console.log('   ✅ Problem and Solution labels in separate paragraphs');
    console.log('\nExamples should now display properly!');
  }
}
