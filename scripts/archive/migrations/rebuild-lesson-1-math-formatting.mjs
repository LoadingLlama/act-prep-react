...
// Lesson 1 with BEAUTIFUL centered math formatting
const lesson1Content = `
            ...
            <div style="background: #f8f9fa; padding: 1.5rem; border-radius: 8px; margin: 1rem 0; text-align: center; font-size: 1.1rem; line-height: 2.2;">
                <div style="margin-bottom: 0.8rem;">√(6 + 10) − 2√(6 − 2) = 0</div>
                <div style="margin-bottom: 0.8rem;">√16 − 2√4 = 0</div>
...
async function rebuildLesson1() {
  console.log('🔧 REBUILDING LESSON 1 WITH BEAUTIFUL MATH FORMATTING...\n');
  ...
  console.log('Adding centered math with:');
  console.log('  • Light gray background boxes');
  console.log('  • Centered alignment');
  console.log('  • Larger font size (1.1rem)');
  console.log('  • Extra line spacing (2.2)');
  console.log('  • Each step on separate line');
  console.log('  • Green checkmarks for correct results\n');
  ...
  if (error) {
    ...
    console.log('✅ Lesson 1 rebuilt with beautiful math formatting!');
  }
}
