...
const updatedContent = `
            ...
            D. sin(90° − 2<em>x</em>°) = <em>a</em><br>
            E. cos(<em>x</em>°) = <em>a</em></p>
...
async function fixLesson12() {
  console.log('📝 Updating Lesson 1.2 to have 5 choices for each example...\n');
  ...
  if (error) {
    ...
    console.log('✅ Lesson 1.2 updated!');
    console.log('   - Example 1: Now has 5 choices (A-E), answer is D (0.7nm)');
    console.log('   - Example 2: Now has 5 choices (A-E), answer is D (sin(90° − 2x°) = a)');
    console.log('   - Example 3: Now has 5 choices (A-E), answer is A (1.5 times larger)');
