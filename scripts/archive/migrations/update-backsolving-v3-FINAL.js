/**
 * Update Backsolving Lesson (Topic 1.1) - VERSION 3 FINAL
 * STRICT adherence to gold standard:
 * - Blue underlines ONLY for terms being DEFINED
 * - Only 2-3 examples where truly necessary
 * - Follow geometry-angles pattern exactly
 */
...
// STRICT RULE: Only use blue underline for terms being DEFINED
const newContent = `<p style="${STYLES.paragraph}">Backsolving is one of the most powerful strategies for the ACT Math section. Instead of solving a problem algebraically, you test the answer choices by plugging them back into the question. This lesson will teach you when and how to use this efficient approach.</p>

<h3 style="${STYLES.h3}">1. What Is Backsolving?</h3>

<p style="${STYLES.paragraph}"><strong style="${STYLES.blueUnderline}">Backsolving</strong> is a strategy where you test answer choices by substituting them into the problem to see which one works.</p>
...
<h4 style="${STYLES.h4Section}"><strong style="${STYLES.blueUnderline}">Step 2: Substitute the Value</strong></h4>
...
<h4 style="${STYLES.h4Section}"><strong style="${STYLES.blueUnderline}">Step 3: Calculate and Check</strong></h4>
...
<h4 style="${STYLES.h4Section}"><strong style="${STYLES.blueUnderline}">Step 4: Adjust if Needed</strong></h4>
...
async function main() {
  ...
  console.log('FINAL UPDATE - Backsolving Lesson v3');
  console.log('Following STRICT gold standard rules:');
  console.log('  - Blue underlines ONLY for defined terms');
  console.log('  - Only 3 examples (not excessive)');
  console.log('  - Bullet-heavy format');
  console.log('='.repeat(80));
  console.log();
  ...
  try {
    ...
    console.log('  - Blue underlined terms: 4 (only DEFINED terms)');
    console.log('  - Examples: 3 (appropriate amount)');
