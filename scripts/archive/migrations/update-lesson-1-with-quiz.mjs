...
const lesson1Content = `
            ...
            <h3 style="margin-top: 5rem; border-bottom: 2px solid #10b981; padding-bottom: 1rem;">Checkpoint Quiz</h3>

            <p style="font-size: 0.95rem; color: #6b7280; font-style: italic; margin-bottom: 2rem;">Test your understanding! Try this problem using the backsolving strategy you just learned.</p>

            <h4>Checkpoint Problem</h4>

            <p><strong>Problem:</strong></p>
            <p>If 2n - 7 = 11, what is the value of n?</p>
            ...
            <p><strong>Solution:</strong></p>
            <p>Remember to start with B or C! Let's test C (n = 8):</p>

            <div style="background: #f8f9fa; padding: 1.5rem; border-radius: 8px; margin: 1rem 0; text-align: center; font-size: 1.15rem; line-height: 2.5;">
                <div style="margin-bottom: 0.8rem;">2(8) - 7 = 11</div>
                <div style="margin-bottom: 0.8rem;">16 - 7 = 11</div>
                <div style="color: #10b981; font-weight: bold;">11 = 11 ✓</div>
            </div>

            <p style="text-align: center; font-style: italic; color: #6b7280; margin: 1rem 0;">Great job! You used backsolving to find the answer quickly!</p>
...
async function updateLesson1() {
  ...
  console.log('Updates:');
  console.log('  ✓ Clearer "Backsolving With Points" explanation');
  console.log('  ✓ Added beginner-friendly checkpoint quiz');
