...
// Lesson 1 with ALL explanations centered and super clear
const lesson1Content = `
            ...
            <p style="text-align: center; font-weight: 600; color: #374151; margin: 1.5rem 0; font-size: 1.05rem;">Let's test x = 6:</p>
            ...
            <p style="text-align: center; font-weight: 600; color: #374151; margin: 1.5rem 0; font-size: 1.05rem;">Let's test A (x = -3):</p>
            ...
            <p style="text-align: center; font-style: italic; color: #6b7280; margin: 1rem 0;">It works! No need to test the other choices.</p>
...
async function rebuildLesson1() {
  console.log('🔧 REBUILDING LESSON 1 - ALL EXPLANATIONS CENTERED & CLEAR...\n');
  ...
  console.log('  ✓ All explanations centered');
  console.log('  ✓ Math in gray boxes, centered, larger font');
  console.log('  ✓ Each math step on separate line');
  console.log('  ✓ Proper square root with overlines');
  console.log('  ✓ Answers centered and bold');
  console.log('  ✓ Commentary centered and styled\n');
  ...
  if (error) {
    ...
    console.log('✅ LESSON 1 IS NOW A MASTERPIECE!');
    console.log('   Every explanation is centered and crystal clear!');
  }
}
