...
<div class="lesson-content">
  ...
  <div style="margin: 3rem 0; padding: 2rem; background: #f8fafb !important; border: 2px solid #e5e7eb; border-radius: 12px;">
    ...
    <div style="margin-bottom: 2rem; padding: 1.5rem; background: #e8f5e9 !important; border-radius: 8px;">
      ...
      <p style="margin: 0 0 1rem 0; font-size: 1.05rem;">If <span style="display: inline-block; position: relative; padding-top: 2px;">√<span style="border-top: 1.5px solid currentColor; padding: 0 2px;">(x + 10)</span></span> − 2<span style="display: inline-block; position: relative; padding-top: 2px;">√<span style="border-top: 1.5px solid currentColor; padding: 0 2px;">(x − 2)</span></span> = 0, what is the value of x?</p>
...
async function updateBacksolvingLesson() {
  ...
  if (error) {
    ...
    console.log('  ✓ Larger base font size (1.05-1.15rem) for all text');
    console.log('  ✓ Clean system font stack (San Francisco/Segoe UI)');
    console.log('  ✓ Square root with proper vinculum using border-top');
    console.log('  ✓ Increased line-height (2.5) for equation spacing');
    console.log('  ✓ Better contrast and visual hierarchy');
    console.log('  ✓ Square root line now covers entire expression');
  }
}
