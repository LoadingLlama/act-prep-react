...
async function uploadLesson() {
  console.log('Reading restructured Math 1.2 lesson...');
  const newContent = fs.readFileSync('restructured-math-1.2-v1.html', 'utf8');
  ...
  if (data && data.length > 0) {
    ...
    console.log('⚠️  No rows updated. Check if lesson_key "substitution" exists.');
  }
}
