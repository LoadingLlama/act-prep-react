...
async function applyBatch6Upgrades() {
  console.log('='.repeat(100));
  console.log('APPLYING BATCH 6 - 100 ACT-AUTHENTIC QUESTION UPGRADES');
  console.log('='.repeat(100));
  console.log();

  const data = JSON.parse(fs.readFileSync('/tmp/act_replacements_batch6_fixed.json'));
  ...
  console.log(`  Batch 5: 100 questions`);
  console.log(`  Batch 6: ${successful} questions`);
  console.log(`  Total:   ${453 + successful} / 1412 weak questions (${((453 + successful)/1412*100).toFixed(1)}%)`);
  console.log(`  Remaining: ${1412 - 453 - successful} questions`);
  console.log('='.repeat(100));
}

applyBatch6Upgrades().catch(console.error);
