...
const html = readFileSync('formatted-exponential-growth.html', 'utf-8');
...
if (existingQuiz) {
  ...
  const { data: newQuiz } = await supabase
    ...
    .insert({
      lesson_id: lesson.id,
      title: 'Exponential Growth Mastery Check',
      quiz_type: 'mastery',
      position: 9999,
      is_required: true
    })
...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: '3', is_correct: false, explanation: 'Exponential Growth can have at most 2 real solutions. Here the discriminant is negative, so 0 real solutions.' },
      { text: 'Infinite', is_correct: false, explanation: 'Exponential Growth have a finite number of solutions. Use discriminant: −16 < 0 means 0 real solutions.' }
    ]
  },
  {
...
console.log('✅ Exponential Growth lesson complete!');
