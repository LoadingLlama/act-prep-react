...
const html = readFileSync('formatted-quadratics.html', 'utf-8');
...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: '3', is_correct: false, explanation: 'Quadratics can have at most 2 real solutions. Here the discriminant is negative, so 0 real solutions.' },
      { text: 'Infinite', is_correct: false, explanation: 'Quadratics have a finite number of solutions. Use discriminant: −16 < 0 means 0 real solutions.' }
    ]
  },
  {
...
console.log('✅ Quadratics lesson complete!');
