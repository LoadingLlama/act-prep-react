...
console.log(`\n${'='.repeat(80)}`);
console.log(`FRACTIONS QUESTIONS - VERIFICATION AND INSERTION`);
console.log(`${'='.repeat(80)}\n`);
console.log(`Total questions to insert: ${allQuestions.length}`);
console.log(`Lesson ID: ${FRACTIONS_LESSON_ID}\n`);
...
(async () => {
  ...
  console.log(`${'='.repeat(80)}\n`);
  console.log('STEP 2: Deleting existing Fractions questions...\n');
