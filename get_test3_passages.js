/**
 * Get all Test 3 passages with their questions
 */
...
async function getTest3Passages() {
  console.log('🔍 Fetching Test 3 passages...\n');

  // Get all unique passage_ids from Test 3 questions
  ...
  console.log(`📊 Found ${passageIds.length} unique passages for Test 3`);
  ...
  console.log('✅ Saved to test3_passages.json\n');
